...
export interface ImageAcquirerProps {
  onImageAcquired: (image: CameraCapturedPicture | ImagePicker.ImagePickerAsset) => void
}
...
export const CameraComponent: React.FC<ImageAcquirerProps> = props => {
  ...
  return (
    <S.Camera type={cameraType} ref={ref}>
      <S.Controls>
...
export const DiagnoseImageAcquirer: React.FC<ImageAcquirerProps> = ({onImageAcquired}) => {
  return (
    <S.Wrapper>
      <S.Container>
